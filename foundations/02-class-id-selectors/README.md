...
### Self Check
- Do the odd numbered `p` elements share a class? (finished)
- Do the even numbered `div` elements have unique IDs? (finished)
- Does the Number 3 element have multiple classes? (finished)
