...
### Self Check
- Did you properly chain class selectors for each rule? (finished) 
- Does the `proportioned` image retain its original square proportions? (finished)
- Does the `distorted` image end up looking squished and, well, distorted? (finished)
