...
### Self Check
- Does each element have a unique class name? (finished)
- Did you use the grouping selector for styles that both elements share? (finished)
- Did you make separate rules for the styles unique to each element? (finished)
